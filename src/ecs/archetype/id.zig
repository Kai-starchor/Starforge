//! Archetype ID used to identify an archetype from the archetype registry.
...
/// The generation of an archetype, used to reuse the dropped archetype's index.
...
pub const ValidateError = error{
    /// The value of the Archetype.Id is invalid.
    InvalidIdVal,
    /// The generation of the Archetype.Id is invalid.
    InvalidGeneration,
};
