...
pub const WS_BORDER = @This(){ .flags = 0x0080_0000 };

/// The window has a title bar (includes the WS_BORDER style).
pub const WS_CAPTION = @This(){ .flags = 0x00C0_0000 };
...
pub const WS_CHILD = @This(){ .flags = 0x4000_0000 };
...
pub const WS_CLIPCHILDREN = @This(){ .flags = 0x0200_0000 };

/// Clips child windows relative to each other.
/// Commonly used when sibling child windows overlap to avoid drawing into each other's client area.
pub const WS_CLIPSIBLINGS = @This(){ .flags = 0x0400_0000 };

/// The window is initially disabled.
pub const WS_DISABLED = @This(){ .flags = 0x0800_0000 };

/// The window has a border of a style typically used with dialog boxes.
/// A window with this style cannot have a title bar.
pub const WS_DLGFRAME = @This(){ .flags = 0x0040_0000 };
...
pub const WS_MINIMIZEBOX = @This(){ .flags = 0x0002_0000 };

/// The window is an overlapped window.
pub const WS_OVERLAPPED = @This(){ .flags = 0x0000_0000 };
...
pub const WS_POPUP = @This(){ .flags = 0x8000_0000 };
...
pub const WS_SYSMENU = @This(){ .flags = 0x0008_0000 };
...
pub const WS_TABSTOP = @This(){ .flags = 0x0001_0000 };

/// The window has a sizing border.
pub const WS_THICKFRAME = @This(){ .flags = 0x0004_0000 };
...
/// `SetWindowPos`.
pub const WS_VISIBLE = @This(){ .flags = 0x1000_0000 };

/// The window has a vertical scroll bar.
pub const WS_VSCROLL = @This(){ .flags = 0x0020_0000 };
